package com.mhwan.circleindicatorlibrary;
...
public class CircleIndicator extends LinearLayout {
    ...
    private void initView(Context context, AttributeSet attrs) {
        TypedArray attrArray = context.obtainStyledAttributes(attrs, R.styleable.CircleIndicator, 0, 0);
        this.counts = attrArray.getInt(R.styleable.CircleIndicator_circle_count, 2);
        this.DefaultMargin = (int) attrArray.getDimension(R.styleable.CircleIndicator_circle_margin, 10f);
        this.size = (int) attrArray.getDimension(R.styleable.CircleIndicator_circle_size, 18f);
        this.mSelectCircle = attrArray.getResourceId(R.styleable.CircleIndicator_select_circle_resource, 0);
        this.mDefaultCircle = attrArray.getResourceId(R.styleable.CircleIndicator_non_select_circle_resource, 0);
